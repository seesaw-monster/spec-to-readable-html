...
単なる Markdown → HTML 変換ではありません。内容を解析して要約・再構成し、フローチャート / シーケンス図 / ER 図やカード・表などの視覚補助を加え、元仕様へのトレーサビリティを保ったまま 1 枚の自己完結 HTML を生成します。
...
- **自己完結 HTML** — 埋め込み CSS、目次、図のズーム表示、印刷対応
